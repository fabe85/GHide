...
public class AdvSubgraphTestGenerator2 extends AbstractTestGenerator {
        ...
        public AdvSubgraphTestGenerator2() {
                super(GeneratorTestRunner.class, AdvSubgraphTestGenerator2.class.getSimpleName(), "tests.generatorTests.AdvSubgraphTestRunner", 1);
                ...
                mParams.add(new SimpleEntry<String, Object[]>("NumVNodesPerNet", new Double[] {5d})); //5d, 10d, 15d, 20d })); //For NetworkGenerators
                mParams.add(new SimpleEntry<String, Object[]>("NumVNets", new Double[] {1d})); //For NetworkGenerators
                mParams.add(new SimpleEntry<String, Object[]>("SNetSize", new Double[] {10d})); //For NetworkGenerators
                mParams.add(new SimpleEntry<String, Object[]>("Min_BW_Dem", new Double[] {1d})); //for Bandwidth Generators
                mParams.add(new SimpleEntry<String, Object[]>("Max_BW_Dem", new Double[] {50d})); //for Bandwidth Generators
                ...
                mParams.add(new SimpleEntry<String, Object[]>("Max_CPU_Dem", new Double[] {50d})); //For CPU generators
